        ...
        <section className={className}>
            <div className={`flex items-center justify-center p-4 backdrop-blur-lg ${isDark ? 'bg-dark-navbar text-white bg-opacity-60' : 'bg-light-navbar'}`}>
                ...
                <nav className={'flex space-x-5 md:space-x-20 items-center'}>
                    ...
                    <Link href="#about" className={`text-md md:text-lg font-bold text-wrap mx-2 ${isDark ? 'hover:text-dark-accent1' : 'hover:text-light-accent1'} align-text-top`}>About Me</Link>
